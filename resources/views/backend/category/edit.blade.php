                            ...
                            <form action="{{route('category.update',['id' => $category->id])}}" method="post"
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input type="status" class="form-control" name="status" id="ststus"
                                            placeholder="your status" value="{{ $category->status }}">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="image_path"
                                                    id="exampleInputFile" value="{{$category->image_path}}">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="image_path" value="{{$category->image_path}}">
                                    </div>
