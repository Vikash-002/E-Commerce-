            ...
            <div class="card card-primary">
              ...
              <form action ="{{route('user.store')}}" method ="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Pincode</label>
                    <input type="text"  name="pincode" class="pincode" class ="form-control"inputmode="numeric" maxlength="6">
                    @error('pincide')
                   <div class ="btn btn-danger">
                     {{$message}}
                   </div>
                  ...
                  <div class="form-group">
                    <label>Phone</label>
                    <input type="tel"  name="phone" class ="form-control" id="" placeholder="Enter phone number">
                    @error('phone')
                   <div class ="btn btn-danger">
                     {{$message}}
                   </div>
                  ...
                  <div>
                  <label>Status</label>
                  <input type="status" name="status" class="form-control" id="" placeholder="Enter status">
                  @error('status')
                   <div class ="btn btn-danger">
                     {{$message}}
                   </div>
