    ...
    <form action="" method="">
            ...
            <main class="main">
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="<?php echo e(asset('image/').'/'.$slider->image); ?>" alt="Banner_image">
                                            </picture>
                ...
                <div class="pt-3 pb-3">
                    <div class="container">
                        ...
                        <div class="banner-group">
                            ...
                            <div class="row">
                                ...
                                <?php if($product->price <=2+ 000): ?> <div class="col-sm-6 col-lg-4">
                                    <div class="banner banner-overlay banner-lg">
                                        <a href="#">
                                            <img src="<?php echo e(asset('/image/').'/'.$product->image); ?>" width='50' height='50'
                    ...
                    <div class="owl-carousel mt-4 mb-3 owl-simple" data-toggle="owl" data-owl-options='{
                        ...
                        <a href="#" class="brand">
                            <img src="<?php echo e(asset('/image_path/').'/'.$brand->image_path); ?>" alt="Brand Name">
                        </a>
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                            ...
                            <div class="product product-7 text-center">
                                ...
                                <div class="product-body">
                                    <h3 class="product-title"><a href="product.html"><?php echo e($product->category->name); ?></a></h3>
                                    <!-- End .product-title -->
                ...
                <div class="col-lg-3">
                    <div class="banner banner-overlay product-banner">
                        <a href="#">
                            ...
                            <img src="<?php echo e(asset('image_path/').'/'.$category->image_path); ?>"  width="200" height="400" alt = "image name">
                        ...
                        <div class="banner-content">
                            ...
                            <div class="banner-bottom">
                                ...
                                <a href="<?php echo e(url('productList/'.$category->id)); ?>" class="btn btn-outline-white banner-link">Shop Now</a>
                            </div>
                        </div>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product product-7">
                                    <figure class="product-media">
                                        ...
                                        <a href="<?php echo e(url('productList/'.$product->id)); ?>">
                                            <img src="<?php echo e(asset('/image/').'/'.$product->image); ?>" width='50' height='50'
                                                class="img img-responsive">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        <h3 class="product-title"><a href="product.html"><?php echo e($product->name); ?></a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
        ...
        <div class="container pb-2">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="banner banner-overlay product-banner">
                        <a href="#">
                            <img src="<?php echo e(asset('front/images/demos/demo-9/banners/banner-6.jpg')); ?>" alt="banner image">
                        </a>
                        <div class="banner-content">
                            <div class="banner-top">
                                <div class="banner-title text-white text-center">
                        ...
                        <div class="tab-pane p-0 fade show active" id="bags-women-tab" role="tabpanel"
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-8-1.jpg')); ?>"
                                                alt="Product image" class="product-image">
                                            <img src="<?php echo e(asset('frontimages/demos/demo-9/products/product-8-2.jpg')); ?>"
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-9-1.jpg')); ?>"
                                                alt="Product image" class="product-image">
                                            <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-9-2.jpg')); ?>"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-10-1.jpg')); ?>"
                                                alt="Product image" class="product-image">
                                            <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-10-2.jpg')); ?>"
                                                alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-10-thumb.jpg')); ?>"
                                                    alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="<?php echo e(asset('front/images/demos/demo-9/products/product-10-2-thumb.jpg')); ?>"
                                                    alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                    </div><!-- End .product-body -->
        ...
        <div class="owl-carousel owl-simple" data-toggle="owl" data-owl-options='{
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/1.jpg')); ?>" alt="img">
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/2.jpg')); ?>" alt="img">
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/3.jpg')); ?>" alt="img">
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/4.jpg')); ?>" alt="img">
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/5.jpg')); ?>" alt="img">
            ...
            <div class="instagram-feed">
                <img src="<?php echo e(asset('front/images/demos/demo-9/instagram/6.jpg')); ?>" alt="img">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="<?php echo e(asset('front/images/demos/demo-9/logo-footer.png')); ?>" class="footer-logo"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8">
                                            ...
                                            <figure class="footer-payments">
                                                <img src="<?php echo e(asset('front/images/payments.png')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="register-email"
                                                    name="email" required>
                                                <span class="text-danger">
                                                    <?php $__errorArgs = ['register-email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('frontend/layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/frontend/index.blade.php ENDPATH**/ ?>